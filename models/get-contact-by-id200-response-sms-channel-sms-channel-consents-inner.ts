 ...
 * @export
 * @interface GetContactById200ResponseSmsChannelSmsChannelConsentsInner
 */
export interface GetContactById200ResponseSmsChannelSmsChannelConsentsInner {
    /**
     * Identifies the current permission status for the SMS channel.
     * @type {string}
     * @memberof GetContactById200ResponseSmsChannelSmsChannelConsentsInner
     */
