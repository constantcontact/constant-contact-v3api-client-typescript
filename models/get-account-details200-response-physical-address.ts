 ...
 * 
 * @export
 * @interface GetAccountDetails200ResponsePhysicalAddress
 */
export interface GetAccountDetails200ResponsePhysicalAddress {
    /**
     * Line 1 of the organization\'s street address.
     * @type {string}
     * @memberof GetAccountDetails200ResponsePhysicalAddress
     */
