 ...
 * 
 * @export
 * @interface GetBouncesReport200ResponseTrackingActivitiesInner
 */
export interface GetBouncesReport200ResponseTrackingActivitiesInner {
    /**
     * The ID that uniquely identifies a contact.
     * @type {string}
     * @memberof GetBouncesReport200ResponseTrackingActivitiesInner
     */
    'contact_id': string;
    /**
