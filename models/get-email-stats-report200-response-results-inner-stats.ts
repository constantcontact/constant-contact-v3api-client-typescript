 ...
 * @export
 * @interface GetEmailStatsReport200ResponseResultsInnerStats
 */
export interface GetEmailStatsReport200ResponseResultsInnerStats {
    /**
     * Number of unique email bounces.
     * @type {number}
     * @memberof GetEmailStatsReport200ResponseResultsInnerStats
     */
    'em_bounces'?: number;
    /**
