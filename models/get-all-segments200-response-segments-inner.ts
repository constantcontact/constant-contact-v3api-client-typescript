 ...
 * 
 * @export
 * @interface GetAllSegments200ResponseSegmentsInner
 */
export interface GetAllSegments200ResponseSegmentsInner {
    /**
     * The segment\'s unique descriptive name.
     * @type {string}
     * @memberof GetAllSegments200ResponseSegmentsInner
     */
    'name'?: string;
    /**
