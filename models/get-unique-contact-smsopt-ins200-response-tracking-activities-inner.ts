 ...
 * 
 * @export
 * @interface GetUniqueContactSMSOptIns200ResponseTrackingActivitiesInner
 */
export interface GetUniqueContactSMSOptIns200ResponseTrackingActivitiesInner {
    /**
     * The unique ID that identifies the contact.
     * @type {string}
     * @memberof GetUniqueContactSMSOptIns200ResponseTrackingActivitiesInner
     */
    'contact_id': string;
    /**
