 ...
 * 
 * @export
 * @interface GetAllActivities200ResponseActivitiesInnerStatus
 */
export interface GetAllActivities200ResponseActivitiesInnerStatus {
    /**
     * The total number of items to be processed.
     * @type {number}
     * @memberof GetAllActivities200ResponseActivitiesInnerStatus
     */
