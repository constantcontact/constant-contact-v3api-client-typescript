 ...
 * 
 * @export
 * @interface CreateCSVImportActivity201ResponseLinks
 */
export interface CreateCSVImportActivity201ResponseLinks {
    /**
     * 
     * @type {GetAllActivities200ResponseActivitiesInnerLinksSelf}
     * @memberof CreateCSVImportActivity201ResponseLinks
     */
