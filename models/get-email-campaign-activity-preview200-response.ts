 ...
 * 
 * @export
 * @interface GetEmailCampaignActivityPreview200Response
 */
export interface GetEmailCampaignActivityPreview200Response {
    /**
     * The unique ID for an email campaign activity.
     * @type {string}
     * @memberof GetEmailCampaignActivityPreview200Response
     */
