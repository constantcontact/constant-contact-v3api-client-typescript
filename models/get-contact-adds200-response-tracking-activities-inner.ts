 ...
 * 
 * @export
 * @interface GetContactAdds200ResponseTrackingActivitiesInner
 */
export interface GetContactAdds200ResponseTrackingActivitiesInner {
    /**
     * The unique ID that identifies the contact.
     * @type {string}
     * @memberof GetContactAdds200ResponseTrackingActivitiesInner
     */
    'contact_id': string;
    /**
