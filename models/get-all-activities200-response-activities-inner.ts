 ...
 * @export
 * @interface GetAllActivities200ResponseActivitiesInner
 */
export interface GetAllActivities200ResponseActivitiesInner {
    /**
     * Unique ID for the activity.
     * @type {string}
     * @memberof GetAllActivities200ResponseActivitiesInner
     */
    'activity_id'?: string;
    /**
