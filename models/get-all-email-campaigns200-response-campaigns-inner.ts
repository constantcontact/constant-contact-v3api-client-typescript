 ...
 * 
 * @export
 * @interface GetAllEmailCampaigns200ResponseCampaignsInner
 */
export interface GetAllEmailCampaigns200ResponseCampaignsInner {
    /**
     * The unique ID used to identify the email campaign (UUID format).
     * @type {string}
     * @memberof GetAllEmailCampaigns200ResponseCampaignsInner
     */
    'campaign_id'?: string;
    /**
